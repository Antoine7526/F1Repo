...
ui <- dashboardPage(
  ...
  #footer = dashboardFooter(p(em("Réalisée par:"),br("Batiste Amistadi, Charline Champ et Antoine Grancher"),style="text-align:center; font-family: Arial; color: grey_dark; background-color: black")), 
