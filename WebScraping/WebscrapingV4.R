...
#Création de la data frame finale
dataDriversParRaces = data.frame(Driver,GrandPrix,Date,Year,Car,Position,Points, stringsAsFactors = FALSE)
...
for(i in 1950:2020){
  ...
  #On actualise notre vecteur des grands prix en actualisant les années correspondantes.
