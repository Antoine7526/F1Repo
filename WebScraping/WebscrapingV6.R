...
for(i in 1950:2020){
  ...
  #On récupère les grands prix sur le 2e site
...
GrandPrix<-substr(GrandPrix,1,nchar(GrandPrix)-11)

Laps[50] <- Laps[51]
Time[50] <- Time[51]
Date <- Date[-c(12,64)]
Year <- year[-c(12,64)]
Winner <- Winner[-c(12,64)]
Car <- Car[-c(12,64)]
Laps <- Laps[-c(12,64)]
Time <- Time[-c(12,64)]
...
Driver <- c(Driver[1:49],Driver[49],Driver[50:1035])
Car <- c(Car[1:49],Car[49],Car[50:1035])
Time <- c(Time[1:49],Time[49],Time[50:1035])
